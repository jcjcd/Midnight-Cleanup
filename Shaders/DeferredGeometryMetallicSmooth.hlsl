...
PixelOut PSMain(VertexOut pin, bool isFrontFace : SV_IsFrontFace)  // SV_IsFrontFace를 픽셀 셰이더의 입력으로 받음
{
    ...
    pout.ORM.r = gAO.Sample(gsamAnisotropicWrap, pin.TexC).r;
    pout.ORM.g = 1.f - gMetallicSmoothness.Sample(gsamAnisotropicWrap, pin.TexC).a;
    pout.ORM.b = gMetallicSmoothness.Sample(gsamAnisotropicWrap, pin.TexC).r;
