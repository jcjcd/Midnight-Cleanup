...
namespace DebugDraw
{
	inline void XM_CALLCONV DrawCube(DirectX::DX11::PrimitiveBatch<DirectX::DX11::VertexPositionColor>* batch,
		CXMMATRIX matWorld,
		FXMVECTOR color)
	{
		...
		DirectX::DX11::VertexPositionColor verts[8];
...
void XM_CALLCONV DebugDraw::Draw(DirectX::DX11::PrimitiveBatch<DirectX::DX11::VertexPositionColor>* batch,
	...
	FXMVECTOR color)
{
	...
	DirectX::DX11::VertexPositionColor verts[24] = {};
...
void XM_CALLCONV DebugDraw::DrawGrid(DirectX::DX11::PrimitiveBatch<DirectX::DX11::VertexPositionColor>* batch,
	FXMVECTOR xAxis,
	FXMVECTOR yAxis,
	FXMVECTOR origin,
	size_t xdivs,
	...
	GXMVECTOR color)
{
	...
	for (size_t i = 0; i <= xdivs; ++i)
	{
		...
		const DirectX::DX11::VertexPositionColor v1(XMVectorSubtract(scale, yAxis), color);
		const DirectX::DX11::VertexPositionColor v2(XMVectorAdd(scale, yAxis), color);
	...
	for (size_t i = 0; i <= ydivs; i++)
	{
		...
		const DirectX::DX11::VertexPositionColor v1(XMVectorSubtract(scale, xAxis), color);
		const DirectX::DX11::VertexPositionColor v2(XMVectorAdd(scale, xAxis), color);
		batch->DrawLine(v1, v2);
	}
}

void XM_CALLCONV DebugDraw::DrawRing(DirectX::DX11::PrimitiveBatch<DirectX::DX11::VertexPositionColor>* batch,
	FXMVECTOR origin,
	FXMVECTOR majorAxis,
	FXMVECTOR minorAxis,
	GXMVECTOR color)
{
	...
	DirectX::DX11::VertexPositionColor verts[c_ringSegments + 1];
...
void XM_CALLCONV DebugDraw::DrawRay(DirectX::DX11::PrimitiveBatch<DirectX::DX11::VertexPositionColor>* batch,
	FXMVECTOR origin,
	FXMVECTOR direction,
	bool normalize,
	FXMVECTOR color)
{
	DirectX::DX11::VertexPositionColor verts[3];
...
void XM_CALLCONV DebugDraw::DrawTriangle(DirectX::DX11::PrimitiveBatch<DirectX::DX11::VertexPositionColor>* batch,
	FXMVECTOR pointA,
	FXMVECTOR pointB,
	FXMVECTOR pointC,
	GXMVECTOR color)
{
	DirectX::DX11::VertexPositionColor verts[4];
...
void XM_CALLCONV DebugDraw::DrawQuad(DirectX::DX11::PrimitiveBatch<DirectX::DX11::VertexPositionColor>* batch,
	FXMVECTOR pointA,
	FXMVECTOR pointB,
	FXMVECTOR pointC,
	GXMVECTOR pointD,
	HXMVECTOR color)
{
	DirectX::DX11::VertexPositionColor verts[5];
	XMStoreFloat3(&verts[0].position, pointA);
	XMStoreFloat3(&verts[1].position, pointB);
	XMStoreFloat3(&verts[2].position, pointC);
