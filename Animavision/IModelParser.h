...
{
public:
	virtual bool LoadModel(Renderer* renderer, const std::string& fileName, Model* model, ModelParserFlags parserFlags) abstract;
	virtual bool LoadModelForEntity(const std::string& fileName, Model* model, ModelParserFlags parserFlags) abstract;
